...
function(CHECK_BLAS_LIBRARIES LIBRARIES _prefix _name _flags _list _deps _addlibdir _subdirs)
  ...
  message(STATUS "***** Using suffixes ${CMAKE_FIND_LIBRARY_SUFFIXES}")
  ...
  foreach(_library ${_list})
    message(STATUS "***** searching for ${_library}")
    if(_library MATCHES "^-")
      ...
      if(_libraries_work)
        ...
        message(STATUS "***** after find: ${${_prefix}_${_lib_var}_LIBRARY}")
  ...
  message(STATUS "***** testing libraries")
  ...
  message(STATUS "***** after test: ${_libraries_work}")
