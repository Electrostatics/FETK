/* ./src_f77/chptrd.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int chptrd_(char *uplo, integer *n, realcomplex *ap, real *d__, 
	real *e, realcomplex *tau, integer *info, ftnlen uplo_len)
{
