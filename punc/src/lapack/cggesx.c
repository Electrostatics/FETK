/* ./src_f77/cggesx.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, char *sense, integer *n, realcomplex *a, integer *lda, realcomplex *b,
	 integer *ldb, integer *sdim, realcomplex *alpha, realcomplex *beta, realcomplex *
	vsl, integer *ldvsl, realcomplex *vsr, integer *ldvsr, real *rconde, real 
	*rcondv, realcomplex *work, integer *lwork, real *rwork, integer *iwork, 
	...
	ftnlen jobvsr_len, ftnlen sort_len, ftnlen sense_len)
{
    ...
    extern /* Subroutine */ int chgeqz_(char *, char *, char *, integer *, 
	    ...
	    realcomplex *, integer *, realcomplex *, integer *, integer *, real *, 
