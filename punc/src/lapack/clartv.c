/* ./src_f77/clartv.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int clartv_(integer *n, realcomplex *x, integer *incx, realcomplex *
	y, integer *incy, real *c__, realcomplex *s, integer *incc)
{
