/* ./src_f77/checon.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int checon_(char *uplo, integer *n, realcomplex *a, integer *lda,
	 integer *ipiv, real *anorm, real *rcond, realcomplex *work, integer *
...
/*  CHECON estimates the reciprocal of the condition number of a realcomplex */
