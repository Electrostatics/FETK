/* ./src_f77/csytrs.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int csytrs_(char *uplo, integer *n, integer *nrhs, realcomplex *
...
/*  CSYTRS solves a system of linear equations A*X = B with a realcomplex */
