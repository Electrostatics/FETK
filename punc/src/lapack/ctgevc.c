/* ./src_f77/ctgevc.f -- translated by f2c (version 20030320).
...
/*     solver. */
    ...
    i__1 = a_dim1 + 1;
    anorm = (r__1 = a[i__1].r, dabs(r__1)) + (r__2 = r_imag(&a[a_dim1 + 1]), 
	    dabs(r__2));
    i__1 = b_dim1 + 1;
    bnorm = (r__1 = b[i__1].r, dabs(r__1)) + (r__2 = r_imag(&b[b_dim1 + 1]), 
	    dabs(r__2));
    rwork[1] = 0.f;
    rwork[*n + 1] = 0.f;
    i__1 = *n;
...
/*        Main loop over eigenvalues */
	...
	for (je = 1; je <= i__1; ++je) {
		...
		i__2 = je + je * a_dim1;
		i__3 = je + je * b_dim1;
		if ((r__2 = a[i__2].r, dabs(r__2)) + (r__3 = r_imag(&a[je + 
			je * a_dim1]), dabs(r__3)) <= safmin && (r__1 = b[
...
/* Computing MAX */
		i__2 = je + je * a_dim1;
		i__3 = je + je * b_dim1;
		r__4 = ((r__2 = a[i__2].r, dabs(r__2)) + (r__3 = r_imag(&a[je 
			+ je * a_dim1]), dabs(r__3))) * ascale, r__5 = (r__1 =
			 b[i__3].r, dabs(r__1)) * bscale, r__4 = max(r__4,
			r__5);
...
/*        Main loop over eigenvalues */
	...
	for (je = *n; je >= 1; --je) {
		...
		i__1 = je + je * a_dim1;
		i__2 = je + je * b_dim1;
		if ((r__2 = a[i__1].r, dabs(r__2)) + (r__3 = r_imag(&a[je + 
			je * a_dim1]), dabs(r__3)) <= safmin && (r__1 = b[
...
/* Computing MAX */
		i__1 = je + je * a_dim1;
		i__2 = je + je * b_dim1;
		r__4 = ((r__2 = a[i__1].r, dabs(r__2)) + (r__3 = r_imag(&a[je 
			+ je * a_dim1]), dabs(r__3))) * ascale, r__5 = (r__1 =
			 b[i__2].r, dabs(r__1)) * bscale, r__4 = max(r__4,
			r__5);
		temp = 1.f / dmax(r__4,safmin);
		i__1 = je + je * a_dim1;
