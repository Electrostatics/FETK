/* ./src_f77/clacrt.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int clacrt_(integer *n, realcomplex *cx, integer *incx, realcomplex *
	cy, integer *incy, realcomplex *c__, realcomplex *s)
{
