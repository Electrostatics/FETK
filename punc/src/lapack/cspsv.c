/* ./src_f77/cspsv.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cspsv_(char *uplo, integer *n, integer *nrhs, realcomplex *
	...
	uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), csptrf_(
	    ...
	    csptrs_(char *, integer *, integer *, realcomplex *, integer *, 
