/* ./src_f77/cgecon.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cgecon_(char *norm, integer *n, realcomplex *a, integer *lda,
	 real *anorm, real *rcond, realcomplex *work, real *rwork, integer *info, 
	ftnlen norm_len)
{
