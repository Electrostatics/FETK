/* ./src_f77/cgttrf.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cgttrf_(integer *n, realcomplex *dl, realcomplex *d__, realcomplex *
	du, realcomplex *du2, integer *ipiv, integer *info)
{
