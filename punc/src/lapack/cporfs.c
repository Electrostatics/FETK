/* ./src_f77/cporfs.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cporfs_(char *uplo, integer *n, integer *nrhs, realcomplex *
	a, integer *lda, realcomplex *af, integer *ldaf, realcomplex *b, integer *ldb,
	 realcomplex *x, integer *ldx, real *ferr, real *berr, realcomplex *work, 
