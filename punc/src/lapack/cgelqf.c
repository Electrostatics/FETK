/* ./src_f77/cgelqf.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cgelqf_(integer *m, integer *n, realcomplex *a, integer *lda,
	 realcomplex *tau, realcomplex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int cgelq2_(integer *, integer *, realcomplex *, 
