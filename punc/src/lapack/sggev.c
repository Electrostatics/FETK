/* ./src_f77/sggev.f -- translated by f2c (version 20030320).
...
/*     (Workspace: need N, prefer N*NB) */
    ...
    if (ilvl) {
	slaset_("Full", n, n, &c_b26, &c_b27, &vl[vl_offset], ldvl, (ftnlen)4)
		;
	i__1 = irows - 1;
	i__2 = irows - 1;
...
/*     Initialize VR */
    ...
    if (ilvr) {
	slaset_("Full", n, n, &c_b26, &c_b27, &vr[vr_offset], ldvr, (ftnlen)4)
		;
    }
