/* ./src_f77/csptrf.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int csptrf_(char *uplo, integer *n, realcomplex *ap, integer *
	ipiv, integer *info, ftnlen uplo_len)
{
    ...
    static realcomplex wkm1, wkp1;
    static integer imax, jmax;
    extern /* Subroutine */ int cspr_(char *, integer *, realcomplex *, realcomplex *,
