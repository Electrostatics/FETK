/* ./src_f77/cgerqf.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cgerqf_(integer *m, integer *n, realcomplex *a, integer *lda,
	 realcomplex *tau, realcomplex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int cgerq2_(integer *, integer *, realcomplex *, 
	    integer *, realcomplex *, realcomplex *, integer *), clarfb_(char *, char 
