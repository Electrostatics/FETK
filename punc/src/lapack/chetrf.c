/* ./src_f77/chetrf.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int chetrf_(char *uplo, integer *n, realcomplex *a, integer *lda,
	...
	uplo_len)
{
    ...
    extern /* Subroutine */ int chetf2_(char *, integer *, realcomplex *, integer 
