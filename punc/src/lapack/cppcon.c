/* ./src_f77/cppcon.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cppcon_(char *uplo, integer *n, realcomplex *ap, real *anorm,
	 real *rcond, realcomplex *work, real *rwork, integer *info, ftnlen 
	uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), clatps_(
	    char *, char *, char *, char *, integer *, realcomplex *, realcomplex *, 
