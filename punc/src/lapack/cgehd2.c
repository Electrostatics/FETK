/* ./src_f77/cgehd2.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cgehd2_(integer *n, integer *ilo, integer *ihi, realcomplex *
	a, integer *lda, realcomplex *tau, realcomplex *work, integer *info)
{
