/* ./src_f77/cgerfs.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cgerfs_(char *trans, integer *n, integer *nrhs, realcomplex *
	...
	realcomplex *work, real *rwork, integer *info, ftnlen trans_len)
{
