/* ./src_f77/cherfs.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cherfs_(char *uplo, integer *n, integer *nrhs, realcomplex *
	a, integer *lda, realcomplex *af, integer *ldaf, integer *ipiv, realcomplex *
	b, integer *ldb, realcomplex *x, integer *ldx, real *ferr, real *berr, 
	realcomplex *work, real *rwork, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int chemv_(char *, integer *, realcomplex *, realcomplex *
	    ...
	    , ftnlen), ccopy_(integer *, realcomplex *, integer *, realcomplex *, 
	    integer *), caxpy_(integer *, realcomplex *, realcomplex *, integer *, 
	    realcomplex *, integer *);
