/* ./src_f77/sgesdd.f -- translated by f2c (version 20030320).
...
/*              Set the right corner of U to identity matrix */
		...
		i__1 = *m - *n;
		i__2 = *m - *n;
		slaset_("F", &i__1, &i__2, &c_b227, &c_b248, &u[*n + 1 + (*n 
...
/*              Set the right corner of VT to identity matrix */
		...
		i__1 = *n - *m;
		i__2 = *n - *m;
		slaset_("F", &i__1, &i__2, &c_b227, &c_b248, &vt[*m + 1 + (*m 
			+ 1) * vt_dim1], ldvt, (ftnlen)1);
