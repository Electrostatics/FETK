/* ./src_f77/dhseqr.f -- translated by f2c (version 20030320).
	...
	integer *lwork, integer *info, ftnlen job_len, ftnlen compz_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), dlarfx_(
...
/*                 real shift */
		    ...
		    dgemv_("No transpose", &i__4, &nv, &c_b10, &h__[l + l * 
			    h_dim1], ldh, vv, &c__1, &d__1, v, &c__1, (ftnlen)
			    12);
		    ++nv;
		} else if (wi[j] > 0.) {
...
/*                 complex conjugate pair of shifts */
		    ...
		    d__1 = wr[j] * -2.;
		    dgemv_("No transpose", &i__4, &nv, &c_b10, &h__[l + l * 
			    h_dim1], ldh, v, &c__1, &d__1, vv, &c__1, (ftnlen)
			    12);
		    i__4 = nv + 1;
