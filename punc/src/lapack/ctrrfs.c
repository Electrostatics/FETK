/* ./src_f77/ctrrfs.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int ctrrfs_(char *uplo, char *trans, char *diag, integer *n, 
	...
	realcomplex *x, integer *ldx, real *ferr, real *berr, realcomplex *work, real 
	...
	diag_len)
{
    ...
    extern /* Subroutine */ int ctrmv_(char *, char *, char *, integer *, 
	    ...
	    integer *, realcomplex *, integer *, ftnlen, ftnlen, ftnlen), clacon_(
