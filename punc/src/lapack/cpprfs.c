/* ./src_f77/cpprfs.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cpprfs_(char *uplo, integer *n, integer *nrhs, realcomplex *
	ap, realcomplex *afp, realcomplex *b, integer *ldb, realcomplex *x, integer *ldx, 
	real *ferr, real *berr, realcomplex *work, real *rwork, integer *info, 
	ftnlen uplo_len)
{
