/* ./src_f77/cgesvx.f -- translated by f2c (version 20030320).
...
/*              leading rank-deficient INFO columns of A. */
		...
		rpvgrw = clantr_("M", "U", "N", info, info, &af[af_offset], 
			ldaf, &rwork[1], (ftnlen)1, (ftnlen)1, (ftnlen)1);
		if (rpvgrw == 0.f) {
		    rpvgrw = 1.f;
		} else {
		    rpvgrw = clange_("M", n, info, &a[a_offset], lda, &rwork[
			    1], (ftnlen)1) / rpvgrw;
		}
		rwork[1] = rpvgrw;
		*rcond = 0.f;
