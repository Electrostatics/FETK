/* ./src_f77/ngsd.f -- translated by f2c (version 20030320).
...
/* * @brief   Nonlinear Gauss-Seidel iteration. */
/* * @version $Id: ngsd.c,v 1.3 2010/08/12 05:45:25 fetk Exp $ */
/* * @attention */
/* * @verbatim */
/* * */
...
/* * @endverbatim */
/* * /////////////////////////////////////////////////////////////////////////// */
/* Subroutine */ int ngsrb_(integer *nx, integer *ny, integer *nz, integer *
	 ...
	 integer *iresid, integer *iadjoint)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ngsrb7_(integer *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    doublereal *, doublereal *, integer *, integer *);
    static integer numdia;
    extern /* Subroutine */ int ngsrb27_(integer *, integer *, integer *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
...
/* *    *** do in one step *** */
    ...
    numdia = ipc[11];
    if (numdia == 7) {
	ngsrb7_(nx, ny, nz, &ipc[1], &rpc[1], &ac[ac_dim1 + 1], &cc[cc_offset]
	...
	ngsrb27_(nx, ny, nz, &ipc[1], &rpc[1], &ac[ac_dim1 + 1], &cc[
	...
	s_wsle(&io___2);
	do_lio(&c__9, &c__1, "% NGSRB: invalid stencil type given...", (
		ftnlen)38);
	e_wsle();
    }
/* * */
...
/* Subroutine */ int ngsrb7_(integer *nx, integer *ny, integer *nz, integer *
	...
	iresid, integer *iadjoint)
{
    ...
    integer oe_dim1, oe_dim2, oe_offset, on_dim1, on_dim2, on_offset, uc_dim1,
	    ...
	    w2_offset, r_dim1, r_dim2, r_offset, i__1, i__2, i__3, i__4, i__5,
	     i__6, i__7;
    ...
    /* Local variables */
    static integer i__, j, k, ifail_tol__, i1, i2, j1, j2, k1, k2;
...
/* * purpose: */
/* * */
/* *    7 diagonal nonlinear gauss-seidel routine. */
/* * */
/* *    this routine applies the gauss-seidel operator or its */
/* *    adjoint depending on the flag iadjoint. */
/* * */
...
/* * %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
/* * %%% nonlinear gauss-seidel-newton iteration (ortega-rheinboldt, page 219) */
/* * %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
/* * */
/* * %%% initial guess */
/* * iters = 0; */
...
/* *    *** do the gauss-seidel iteration itmax times *** */
    i1 = (1 - *iadjoint << 1) + *iadjoint * (*nx - 1);
    i2 = (*iadjoint << 1) + (1 - *iadjoint) * (*nx - 1);
    j1 = (1 - *iadjoint << 1) + *iadjoint * (*ny - 1);
    j2 = (*iadjoint << 1) + (1 - *iadjoint) * (*ny - 1);
    k1 = (1 - *iadjoint << 1) + *iadjoint * (*nz - 1);
    k2 = (*iadjoint << 1) + (1 - *iadjoint) * (*nz - 1);
    istep = -(*iadjoint) + (1 - *iadjoint);
    i__1 = *itmax;
...
/* mdir 3 2 */
	    i__4 = j2;
	    i__5 = istep;
	    for (j = j1; i__5 < 0 ? j >= i__4 : j <= i__4; j += i__5) {
/* mdir 3 3 */
		i__6 = i2;
		i__7 = istep;
		for (i__ = i1; i__7 < 0 ? i__ >= i__6 : i__ <= i__6; i__ += 
			i__7) {
/* * */
...
/* *    *** messages *** */
    if (ifail_tol__ > 0) {
	s_wsle(&io___27);
	do_lio(&c__9, &c__1, "% NGSRB: 1d newton tolerance failures:    ", (
		ftnlen)42);
...
/* Subroutine */ int ngsrb27_(integer *nx, integer *ny, integer *nz, integer *
	ipc, doublereal *rpc, doublereal *oc, doublereal *cc, doublereal *fc, 
	...
	doublereal *omega, integer *iresid, integer *iadjoint)
{
    ...
    integer oe_dim1, oe_dim2, oe_offset, on_dim1, on_dim2, on_offset, uc_dim1,
	    ...
	    r_dim2, r_offset, i__1, i__2, i__3, i__4, i__5, i__6, i__7;
...
/* * purpose: */
/* * */
/* *    27 diagonal nonlinear gauss-seidel routine. */
/* * */
/* *    this routine applies the gauss-seidel operator or its */
/* *    adjoint depending on the flag iadjoint. */
/* * */
...
/* Subroutine */ int ngsrb7x_(integer *nx, integer *ny, integer *nz, integer *
	ipc, doublereal *rpc, doublereal *oc, doublereal *cc, doublereal *fc, 
	doublereal *oe, doublereal *on, doublereal *uc, doublereal *x, 
	doublereal *w1, doublereal *w2, doublereal *r__, integer *itmax, 
	integer *iters, doublereal *errtol, doublereal *omega, integer *
...
/* * purpose: */
/* * */
/* *    fast 7 diagonal nonlinear red/black gauss-seidel routine. */
/* * */
/* *    this routine applies the red/black gauss-seidel operator or its */
/* *    adjoint depending on the flag iadjoint.  note that the adjoint */
/* *    in this case is simply doing the red or black points first. */
/* * */
...
/* mdir 3 2 */
	    i__3 = *ny - 1;
	    for (j = 2; j <= i__3; ++j) {
/* ZZZ           ioff = mod((j+k+2),2) */
		ioff = (1 - *iadjoint) * ((j + k + 2) % 2) + *iadjoint * (1 - 
			(j + k + 2) % 2);
/* mdir 3 3 */
		i__4 = *nx - 1;
...
/* mdir 3 2 */
	    i__3 = *ny - 1;
	    for (j = 2; j <= i__3; ++j) {
/* ZZZ           ioff = 1-mod((j+k+2),2) */
		ioff = *iadjoint * ((j + k + 2) % 2) + (1 - *iadjoint) * (1 - 
			(j + k + 2) % 2);
/* mdir 3 3 */
		i__4 = *nx - 1;
		for (i__ = ioff + 2; i__ <= i__4; i__ += 2) {
