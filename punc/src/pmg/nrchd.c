/* ./src_f77/nrchd.f -- translated by f2c (version 20030320).
...
/* * @brief   Nonlinear version of Richardson iteration. */
/* * @version $Id: nrchd.c,v 1.3 2010/08/12 05:45:26 fetk Exp $ */
/* * @attention */
/* * @verbatim */
/* * */
...
/* Subroutine */ int nrich7_(integer *nx, integer *ny, integer *nz, integer *
...
/* * purpose: */
/* * */
/* *   nonlinear richardson's iteration (hackbusch, page 185) */
/* * */
/* * author:  michael holst */
/* * ********************************************************************* */
/* * */
...
/* Subroutine */ int nrich27_(integer *nx, integer *ny, integer *nz, integer *
	ipc, doublereal *rpc, doublereal *oc, doublereal *cc, doublereal *fc, 
	...
	doublereal *omega, integer *iresid, integer *iadjoint)
{
    ...
    extern /* Subroutine */ int mresid27_1s__(integer *, integer *, integer *,
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *), nmresid27_1s__(integer 
