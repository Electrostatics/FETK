/* ./src_f77/cher.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int cher_(char *uplo, integer *n, real *alpha, realcomplex *x, 
	integer *incx, realcomplex *a, integer *lda, ftnlen uplo_len)
{
