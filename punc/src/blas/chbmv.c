/* ./src_f77/chbmv.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int chbmv_(char *uplo, integer *n, integer *k, realcomplex *
	alpha, realcomplex *a, integer *lda, realcomplex *x, integer *incx, realcomplex *
	beta, realcomplex *y, integer *incy, ftnlen uplo_len)
{
