/* ./src_f77/chpr2.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int chpr2_(char *uplo, integer *n, realcomplex *alpha, realcomplex *
	x, integer *incx, realcomplex *y, integer *incy, realcomplex *ap, ftnlen 
	uplo_len)
{
