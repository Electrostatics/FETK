/* ./src_f77/chpmv.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int chpmv_(char *uplo, integer *n, realcomplex *alpha, realcomplex *
	ap, realcomplex *x, integer *incx, realcomplex *beta, realcomplex *y, integer *
