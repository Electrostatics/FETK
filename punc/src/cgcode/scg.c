/* ./src_f77/scg.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int scg_(S_fp matvec, real *a, integer *ia, real *x, real *b,
	 integer *n, integer *iparam, real *rparam, integer *iwork, real *r__,
	 real *ap, real *d__, real *e, real *cndwk, integer *ierror)
{
    /* Format strings */
    static char fmt_6[] = "(\002 THE METHOD IS CONJUGATE GRADIENTS (CG)\002,"
	    "/)";
    ...
    static cilist io___33 = { 0, 0, 0, fmt_70, 0 };
...
/*             MAIL STOP B265 */
/*             LOS ALAMOS, NM 87545 */
/* ***PURPOSE  THIS ROUTINE SOLVES THE SYMMETRIC POSITIVE DEFINITE LINEAR */
/*            SYSTEM AX = B.  THE METHOD OF CONJUGATE GRADIENTS IS USED. */
/* ***DESCRIPTION */
...
/*    SCG IMPLEMENTS THE CLASSICAL CONJUGATE GRADIENT METHOD OF HESTENES */
/*    AND STIEFEL, USING THE OMIN ALGORITHM GIVEN BY: */
...
/*    EIGENVALUES, THE ALGORITHM WILL CONVERGE IN AT MOST M STEPS.  AT */
/*    EACH STEP THE ALGORITHM MINIMIZES THE A-NORM OF THE ERROR.  THAT */
...
/*    SCG IS ONE ROUTINE IN A PACKAGE OF CG CODES; THE OTHERS ARE: */
...
/* Computing 2nd power */
    r__1 = rnorm;
    alpha = r__1 * r__1 / sdot_(n, &ap[1], &c__1, &b[1], &c__1);
