/* ./src_f77/dpcg.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int dpcg_(S_fp matvec, S_fp pcondl, doublereal *a, integer *
	ia, doublereal *x, doublereal *b, integer *n, doublereal *q, integer *
	iq, integer *iparam, doublereal *rparam, integer *iwork, doublereal *
	r__, doublereal *h__, doublereal *d__, doublereal *e, doublereal *
	cndwk, integer *ierror)
{
    /* Format strings */
    ...
    static doublereal alpha, denom, oldrh, rdoth;
    ...
    static doublereal eigmin, eigmax;
...
/*    DPCG IMPLEMENTS THE PRECONDITIONED CONJUGATE GRADIENT METHOD, */
...
/*    DPCG IS ONE ROUTINE IN A PACKAGE OF CG CODES; THE OTHERS ARE: */
...
/* ***ROUTINES CALLED  DONEST,D1MACH,DCGCHK,DAXPY,DDOT,DNRM2 */
/* ***END PROLOGUE  DPCG */

/*     *** DECLARATIONS *** */

/* ***FIRST EXECUTABLE STATEMENT  DPCG */
...
/*     *** INITIALIZE RDOTH *** */
    rdoth = ddot_(n, &r__[1], &c__1, &b[1], &c__1);
...
/*     *** COMPUTE NEW X *** */
    alpha = rdoth / ddot_(n, &h__[1], &c__1, &b[1], &c__1);
...
/*     *** COMPUTE NEW P  *** */
    oldrh = rdoth;
    rdoth = ddot_(n, &r__[1], &c__1, &h__[1], &c__1);
    beta = rdoth / oldrh;
    i__1 = *n;
    for (i__ = 1; i__ <= i__1; ++i__) {
