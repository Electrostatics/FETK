      SUBROUTINE SCGNE(MATVEC,A,IA,X,B,N,IPARAM,RPARAM,IWORK,
     2   R,H,D,E,CNDWK,IERROR)
C***BEGIN PROLOGUE  SCGNE
...
C***LONG DESCRIPTION
C
C    SCGNE IMPLEMENTS THE CLASSICAL CONJUGATE GRADIENT METHOD APPLIED TO 
...
C
C    SCGNE IS ONE ROUTINE IN A PACKAGE OF CG CODES; THE OTHERS ARE:
C
...
C
C***FIRST EXECUTABLE STATEMENT  SCGNE
 1    CONTINUE
C
...
C        *** UPDATE PARAMETERS ***
 ...
 80         FORMAT(' NEW COND ESTIMATE FOR A  = ', E12.5, /)
         ENDIF
      ENDIF
C
