/* ./src_f77/scgchk.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int scgchk_(integer *ipar, real *rpar, integer *n)
{
    /* Format strings */
    static char fmt_5[] = "(\002 THE ITERATION PARAMETERS ARE \002,/,4x,\002"
	    "N      = \002,i5,/,4x,\002ITMAX  = \002,i5,/,4x,\002ICYCLE = "
	    "\002,i5,/,4x,\002NCE    = \002,i5,/,4x,\002ERRTOL = \002,e12.5)";
    static char fmt_11[] = "(\002 ERROR IN SCGCHK: N .LE. 0\002,/)";
    static char fmt_12[] = "(/,\002 WARNING IN SCGCHK: ITMAX .LE. 0\002,/)";
    static char fmt_13[] = "(/,\002 WARNING IN SCGCHK: ICYCLE < 0 .OR. ICYCL"
	    "E > ITMAX\002,/)";
    static char fmt_14[] = "(/,\002 WARNING IN SCGCHK: NCE .LT. 0; SET TO "
	    "0\002,/)";
    static char fmt_15[] = "(/,\002 WARNING IN SCGCHK: ERRTOL .LE. MACHINE E"
	    "PSILON\002,/)";
...
/* ***BEGIN PROLOGUE  SCGCHK */
/* ***REFER TO  SCG,SCR,SPCG,SCGNR,SCGNE,SPCGNR,SPCGNE,SPPCG,SPCGCA */
...
/* ***FIRST EXECUTABLE STATEMENT  SCGCHK */
...
/*     *** OUTPUT THE PARAMETERS *** */
    ...
    do_fio(&c__1, (char *)&rpar[1], (ftnlen)sizeof(real));
    e_wsfe();
