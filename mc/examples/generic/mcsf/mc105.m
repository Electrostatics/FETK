...
%
% Dimension:     3
% Domain:        A single tetrahedron.
% Boundary:      Three bndry nodes are dirichlet-type, one is neumann.
%                I.e., one face is dirichlet, and the other three are neumann.
%
% rcsid="$Id: mc105.m,v 1.4 2010/08/12 05:17:17 fetk Exp $"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
simplices=1;         % number of simplices
