...
%
% Dimension:     3
% Domain:        Two tetrahedra.
% Boundary:      Three bndry nodes are dirichlet-type, all others neumann.
%                I.e., one face is dirichlet, the rest neumann.
%
% rcsid="$Id: mc107.m,v 1.4 2010/08/12 05:17:18 fetk Exp $"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------- ---- ---- ------------------- ---------------------------------------
0         0    0    2    2    2    0    0 2 1 3
1         0    0    1    2    2    0    0 1 2 4
];
