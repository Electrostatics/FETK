 ...
 * 
 * rcsid="$Id: mypde4.c,v 1.12 2010/08/12 05:17:26 fetk Exp $"
 * ***************************************************************************
 */
 ...
 *
 *     Problem type:          Karen Camarda's simple 2D system test problem #2
 *     Spatial dimension:     2
 *     Product dimension:     2
...
VEMBED(rcsid="$Id: mypde4.c,v 1.12 2010/08/12 05:17:26 fetk Exp $")
...
{
    double value;
    value = -y*y*VSIN(x*y) - x*x*VSIN(x*y);
    return value;
}
