...
//
//  rcsid="$Id: mypde-test2.c,v 1.3 2010/08/12 05:16:37 fetk Exp $"
// //////////////////////////////////////////////////////////////////////// */
...
VEMBED(rcsid="$Id: mypde-test2.c,v 1.3 2010/08/12 05:16:37 fetk Exp $")
...
VPRIVATE double kActPrime = 1e-3;

VPRIVATE double FAC_a = 0.03161750710506;
...
VPRIVATE double FAC(int d, int m, double *x, double t) {
    ...
    return VEXP( -1.0 * diffusionCoeff * FAC_a * FAC_a * t );
}
...
VPRIVATE double FACt(int d, int m, double *x, double t) {
    ...
    return  -1.0 * diffusionCoeff * VSQR( FAC_a ) * FAC(d, m, x, t);
}
...
VPRIVATE double Ux0(int d, int m, double *x, double t) {
    return FACx0(d,m,x,t) * UU(d,m,x,t) + FAC(d,m,x,t) * UUx0(d,m,x,t);
}
VPRIVATE double Ux1(int d, int m, double *x, double t) {
    return FACx1(d,m,x,t) * UU(d,m,x,t) + FAC(d,m,x,t) * UUx1(d,m,x,t);
}
VPRIVATE double Ux2(int d, int m, double *x, double t) {
    if (d==2) return 0.;
    else return FACx2(d,m,x,t) * UU(d,m,x,t) + FAC(d,m,x,t) * UUx2(d,m,x,t);
}
...
VPRIVATE double my_C(int d, int m, double *x) {
    ...
    } else if (fType == 6) { /* Robin condition */
