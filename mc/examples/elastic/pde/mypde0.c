 ...
 * 
 * rcsid="$Id: mypde0.c,v 1.3 2010/08/12 05:16:56 fetk Exp $"
 * ***************************************************************************
 */
...
VEMBED(rcsid="$Id: mypde0.c,v 1.3 2010/08/12 05:16:56 fetk Exp $")

const int P_FRC=1; /* 0=internal force,1=traction force,2=int+tract         */
